...
```
P0 ──→ P1 ──→ P2 ──→ P3 ──→ P4 ──→ P4.5 ──→ P5 ──→ P6 ──→ P7 ──→ P8 ──→ P9 ──→ P10 ──→ P11
MVP    流程    数据源  套件调度 仓库    Runner   MCP    用户   测试   数据   站内   性能    资产
       编排    节点补全 报告告警 用例                     权限   管理   统计   助手   插件    归属
       断言    套件    趋势                                      （2026-09-04 新增，P6–P10 详见
                                                                DEVELOPMENT_PLAN_P6-P10.md；
                                                                原 P6 性能/插件/版本顺延为 P10；
                                                                P11 于 2026-09-07 立项，同文件
                                                                十六章）
```
...
> `DEVELOPMENT_PLAN_P6-P10.md` 十六章。一句话范围：14 张 P0–P3 核心表补
